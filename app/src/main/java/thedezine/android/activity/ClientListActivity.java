...
public class ClientListActivity extends AppCompatActivity {
    ...
    FloatingActionButton clientFAB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initToolbar();
        clientFAB=(FloatingActionButton)findViewById(R.id.clientFAB);
        initComp();
        ...
        clientFAB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ClientListActivity.this, EnquiryActivity.class);
        ...
        img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ClientListActivity.this, PortifolioDetailsActivity.class);
                startActivity(intent);
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
            }
        });
